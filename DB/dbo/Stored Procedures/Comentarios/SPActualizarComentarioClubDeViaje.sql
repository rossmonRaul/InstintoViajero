CREATE PROCEDURE [dbo].[SPActualizarComentarioClubDeViaje]
( 
  @IdComentarioClubDeViaje INT 
		...
		SET @Vfecha = GETDATE();
            ...
            BEGIN TRY
                BEGIN TRAN ACTUALIZAR
                    BEGIN
							UPDATE dbo.ComentariosClubDeViaje SET
															
								Comentario = @Comentario
								, Estado = @Estado
                                , FechaModificacion = @Vfecha
                                , UsuarioModificacion = @Usuario
                                WHERE IdComentarioClubDeViaje = @IdComentarioClubDeViaje                         
