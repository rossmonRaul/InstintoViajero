CREATE PROCEDURE [dbo].[SPActualizarCuentaBancariaClubDeViaje]
( 
  @IdCuentaBancariaClubDeViaje INT 
, @Banco NVARCHAR(30)
, @Numero NUMERIC(16,0)
		...
		SET @Vfecha = GETDATE();
            ...
            BEGIN TRY
                BEGIN TRAN ACTUALIZAR
                    BEGIN
							UPDATE dbo.[CuentasBancariasClubDeViaje] SET
                                ...
                                WHERE IdCuentaBancariaClubDeViaje = @IdCuentaBancariaClubDeViaje                         
							

							-- Ejecuta SPInsertarBitacora
							DECLARE @vDetalle NVARCHAR(600);						
							SET @vDetalle = 'IdCuentaBancariaClubDeViaje: ' +  CAST(@IdCuentaBancariaClubDeViaje AS NVARCHAR(10)) + ', ' +
										'Banco: ' + @Banco + ', ' +
							...
							EXEC [dbo].[SPInsertarBitacora] 'CuentasBancariasClubDeViaje', 'A', @vDetalle, @Vfecha, @Usuario;					
                    END
