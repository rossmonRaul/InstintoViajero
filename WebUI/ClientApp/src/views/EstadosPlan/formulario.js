                ...
                <Form noValidate validated={validated} onSubmit={onClickAceptar}>
                    <Row>
                        <InputText id='txt-codEstadoPlan' label='Código de estado:' type='text' placeholder='Ingrese el código' value={codEstadoPlan}
                            onChange={onChangeCodEstadoPlan} mensajeValidacion="El código de estado" className="col-md-4" readOnly={proceso == 2} />
                        ...
                        <InputText id='txt-descEstadoPlan' label='Descripción de estado:' type='text' placeholder='Ingrese la descripción' value={descEstadoPlan}
                            onChange={onChangeDescEstadoPlan} mensajeValidacion="El código de estado de plan es requerido" className="col-md-8" readOnly={proceso == 2} />
                    </Row>                  
                    <br />
